...
module.exports.routes = {
 ...
 'GET /': 'PrincipalController.inicio',
  ...
  'GET /admin/ordenes/:id_cliente': 'AdminController.clientesOrdenes',

  'GET /admin/ordenes_detalles/:id_orden': 'AdminController.detallesOrdenes',

  'GET /admin/estado-cliente/:id_cliente': 'AdminController.estadoCliente',

  'GET /admin/administradores': 'AdminController.administradores',

  'GET /admin/estado_admin/:id_admin': 'AdminController.estadoAdmin',
